...
impl W {
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn ch0(&mut self) -> CH0_W<INTE_SPEC> {
        CH0_W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    pub fn ch1(&mut self) -> CH1_W<INTE_SPEC> {
        CH1_W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    pub fn ch2(&mut self) -> CH2_W<INTE_SPEC> {
        CH2_W::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    pub fn ch3(&mut self) -> CH3_W<INTE_SPEC> {
        CH3_W::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    pub fn ch4(&mut self) -> CH4_W<INTE_SPEC> {
        CH4_W::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    pub fn ch5(&mut self) -> CH5_W<INTE_SPEC> {
        CH5_W::new(self, 5)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    pub fn ch6(&mut self) -> CH6_W<INTE_SPEC> {
        CH6_W::new(self, 6)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    pub fn ch7(&mut self) -> CH7_W<INTE_SPEC> {
        CH7_W::new(self, 7)
    }
}
