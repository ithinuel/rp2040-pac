...
pub type R = crate::R<CH11_DBG_CTDREQ_SPEC>;
#[doc = "Register `CH11_DBG_CTDREQ` writer"]
pub type W = crate::W<CH11_DBG_CTDREQ_SPEC>;
#[doc = "Field `CH11_DBG_CTDREQ` reader - "]
pub type CH11_DBG_CTDREQ_R = crate::FieldReader;
#[doc = "Field `CH11_DBG_CTDREQ` writer - "]
pub type CH11_DBG_CTDREQ_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    #[doc = "Bits 0:5"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CH11_DBG_CTDREQ")
            .field("ch11_dbg_ctdreq", &self.ch11_dbg_ctdreq())
            .finish()
    }
}
impl W {
