...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CH7_DBG_CTDREQ")
            .field("ch7_dbg_ctdreq", &self.ch7_dbg_ctdreq())
            .finish()
    }
}
impl W {
