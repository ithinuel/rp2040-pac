...
pub type R = crate::R<CH8_DBG_CTDREQ_SPEC>;
#[doc = "Register `CH8_DBG_CTDREQ` writer"]
pub type W = crate::W<CH8_DBG_CTDREQ_SPEC>;
#[doc = "Field `CH8_DBG_CTDREQ` reader - "]
pub type CH8_DBG_CTDREQ_R = crate::FieldReader;
#[doc = "Field `CH8_DBG_CTDREQ` writer - "]
pub type CH8_DBG_CTDREQ_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    #[doc = "Bits 0:5"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CH8_DBG_CTDREQ")
            .field("ch8_dbg_ctdreq", &self.ch8_dbg_ctdreq())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:5"]
    #[inline(always)]
    pub fn ch8_dbg_ctdreq(&mut self) -> CH8_DBG_CTDREQ_W<CH8_DBG_CTDREQ_SPEC> {
        CH8_DBG_CTDREQ_W::new(self, 0)
    }
}
