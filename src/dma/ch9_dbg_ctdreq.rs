...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CH9_DBG_CTDREQ")
            .field("ch9_dbg_ctdreq", &self.ch9_dbg_ctdreq())
            .finish()
    }
}
impl W {
