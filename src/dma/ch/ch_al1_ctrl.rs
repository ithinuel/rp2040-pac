#[doc = "Register `CH_AL1_CTRL` reader"]
pub type R = crate::R<CH_AL1_CTRL_SPEC>;
#[doc = "Register `CH_AL1_CTRL` writer"]
pub type W = crate::W<CH_AL1_CTRL_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`ch_al1_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch_al1_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CH_AL1_CTRL_SPEC;
impl crate::RegisterSpec for CH_AL1_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch_al1_ctrl::R`](R) reader structure"]
impl crate::Readable for CH_AL1_CTRL_SPEC {}
