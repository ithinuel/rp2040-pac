...
You can [`read`](crate::Reg::read) this register and get [`nvic_iser::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`nvic_iser::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).  

For information about available fields see [`mod@nvic_iser`] module"]
...
You can [`read`](crate::Reg::read) this register and get [`nvic_icer::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`nvic_icer::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).  

For information about available fields see [`mod@nvic_icer`] module"]
...
You can [`read`](crate::Reg::read) this register and get [`nvic_ispr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`nvic_ispr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).  

For information about available fields see [`mod@nvic_ispr`] module"]
...
You can [`read`](crate::Reg::read) this register and get [`nvic_icpr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`nvic_icpr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).  

For information about available fields see [`mod@nvic_icpr`] module"]
...
For information about available fields see [`mod@nvic_ipr0`] module"]
...
For information about available fields see [`mod@nvic_ipr1`] module"]
...
For information about available fields see [`mod@nvic_ipr2`] module"]
...
For information about available fields see [`mod@nvic_ipr3`] module"]
...
For information about available fields see [`mod@nvic_ipr4`] module"]
...
For information about available fields see [`mod@nvic_ipr5`] module"]
...
For information about available fields see [`mod@nvic_ipr6`] module"]
...
For information about available fields see [`mod@nvic_ipr7`] module"]
...
For information about available fields see [`mod@mpu_type`] module"]
...
For information about available fields see [`mod@mpu_ctrl`] module"]
...
For information about available fields see [`mod@mpu_rnr`] module"]
...
For information about available fields see [`mod@mpu_rbar`] module"]
...
For information about available fields see [`mod@mpu_rasr`] module"]
