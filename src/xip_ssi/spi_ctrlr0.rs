...
pub type TRANS_TYPE_W<'a, REG> = crate::FieldWriter<'a, REG, 2, TRANS_TYPE_A>;
...
pub type WAIT_CYCLES_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
...
pub type SPI_DDR_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type INST_DDR_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SPI_RXDS_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type XIP_CMD_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
