...
pub type R = crate::R<FRCE_OFF_SPEC>;
#[doc = "Register `FRCE_OFF` writer"]
pub type W = crate::W<FRCE_OFF_SPEC>;
...
impl W {
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn rosc(&mut self) -> ROSC_W<FRCE_OFF_SPEC> {
        ROSC_W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    pub fn xosc(&mut self) -> XOSC_W<FRCE_OFF_SPEC> {
        XOSC_W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    pub fn clocks(&mut self) -> CLOCKS_W<FRCE_OFF_SPEC> {
        CLOCKS_W::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    pub fn resets(&mut self) -> RESETS_W<FRCE_OFF_SPEC> {
        RESETS_W::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    pub fn busfabric(&mut self) -> BUSFABRIC_W<FRCE_OFF_SPEC> {
        BUSFABRIC_W::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    pub fn rom(&mut self) -> ROM_W<FRCE_OFF_SPEC> {
        ROM_W::new(self, 5)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    pub fn sram0(&mut self) -> SRAM0_W<FRCE_OFF_SPEC> {
        SRAM0_W::new(self, 6)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    pub fn sram1(&mut self) -> SRAM1_W<FRCE_OFF_SPEC> {
        SRAM1_W::new(self, 7)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    pub fn sram2(&mut self) -> SRAM2_W<FRCE_OFF_SPEC> {
        SRAM2_W::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    pub fn sram3(&mut self) -> SRAM3_W<FRCE_OFF_SPEC> {
        SRAM3_W::new(self, 9)
    }
    #[doc = "Bit 10"]
    #[inline(always)]
    pub fn sram4(&mut self) -> SRAM4_W<FRCE_OFF_SPEC> {
        SRAM4_W::new(self, 10)
    }
    #[doc = "Bit 11"]
    #[inline(always)]
    pub fn sram5(&mut self) -> SRAM5_W<FRCE_OFF_SPEC> {
        SRAM5_W::new(self, 11)
    }
    #[doc = "Bit 12"]
    #[inline(always)]
    pub fn xip(&mut self) -> XIP_W<FRCE_OFF_SPEC> {
        XIP_W::new(self, 12)
    }
    #[doc = "Bit 13"]
    #[inline(always)]
    pub fn vreg_and_chip_reset(&mut self) -> VREG_AND_CHIP_RESET_W<FRCE_OFF_SPEC> {
        VREG_AND_CHIP_RESET_W::new(self, 13)
    }
    #[doc = "Bit 14"]
    #[inline(always)]
    pub fn sio(&mut self) -> SIO_W<FRCE_OFF_SPEC> {
        SIO_W::new(self, 14)
    }
    #[doc = "Bit 15"]
    #[inline(always)]
    pub fn proc0(&mut self) -> PROC0_W<FRCE_OFF_SPEC> {
        PROC0_W::new(self, 15)
    }
    #[doc = "Bit 16"]
    #[inline(always)]
    pub fn proc1(&mut self) -> PROC1_W<FRCE_OFF_SPEC> {
        PROC1_W::new(self, 16)
    }
}
#[doc = "Force into reset (i.e. power it off)  

You can [`read`](crate::Reg::read) this register and get [`frce_off::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`frce_off::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
