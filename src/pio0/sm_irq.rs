...
For information about available fields see [`mod@irq_inte`] module"]
...
For information about available fields see [`mod@irq_intf`] module"]
...
For information about available fields see [`mod@irq_ints`] module"]
