...
pub type R = crate::R<PROC0_INTS_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`proc0_ints::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
