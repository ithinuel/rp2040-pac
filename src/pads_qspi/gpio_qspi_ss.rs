#[doc = "Register `GPIO_QSPI_SS` reader"]
pub type R = crate::R<GPIO_QSPI_SS_SPEC>;
#[doc = "Register `GPIO_QSPI_SS` writer"]
pub type W = crate::W<GPIO_QSPI_SS_SPEC>;
...
impl W {
    #[doc = "Bit 0 - Slew rate control. 1 = Fast, 0 = Slow"]
    #[inline(always)]
    pub fn slewfast(&mut self) -> SLEWFAST_W<GPIO_QSPI_SS_SPEC> {
        SLEWFAST_W::new(self, 0)
    }
    #[doc = "Bit 1 - Enable schmitt trigger"]
    #[inline(always)]
    pub fn schmitt(&mut self) -> SCHMITT_W<GPIO_QSPI_SS_SPEC> {
        SCHMITT_W::new(self, 1)
    }
    #[doc = "Bit 2 - Pull down enable"]
    #[inline(always)]
    pub fn pde(&mut self) -> PDE_W<GPIO_QSPI_SS_SPEC> {
        PDE_W::new(self, 2)
    }
    #[doc = "Bit 3 - Pull up enable"]
    #[inline(always)]
    pub fn pue(&mut self) -> PUE_W<GPIO_QSPI_SS_SPEC> {
        PUE_W::new(self, 3)
    }
    #[doc = "Bits 4:5 - Drive strength."]
    #[inline(always)]
    pub fn drive(&mut self) -> DRIVE_W<GPIO_QSPI_SS_SPEC> {
        DRIVE_W::new(self, 4)
    }
    #[doc = "Bit 6 - Input enable"]
    #[inline(always)]
    pub fn ie(&mut self) -> IE_W<GPIO_QSPI_SS_SPEC> {
        IE_W::new(self, 6)
    }
    #[doc = "Bit 7 - Output disable. Has priority over output enable from peripherals"]
    #[inline(always)]
    pub fn od(&mut self) -> OD_W<GPIO_QSPI_SS_SPEC> {
        OD_W::new(self, 7)
    }
}
#[doc = "Pad control register  

You can [`read`](crate::Reg::read) this register and get [`gpio_qspi_ss::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpio_qspi_ss::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GPIO_QSPI_SS_SPEC;
impl crate::RegisterSpec for GPIO_QSPI_SS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio_qspi_ss::R`](R) reader structure"]
impl crate::Readable for GPIO_QSPI_SS_SPEC {}
#[doc = "`write(|w| ..)` method takes [`gpio_qspi_ss::W`](W) writer structure"]
impl crate::Writable for GPIO_QSPI_SS_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIO_QSPI_SS to value 0x5a"]
impl crate::Resettable for GPIO_QSPI_SS_SPEC {
