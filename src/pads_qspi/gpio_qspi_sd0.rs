#[doc = "Register `GPIO_QSPI_SD0` reader"]
pub type R = crate::R<GPIO_QSPI_SD0_SPEC>;
#[doc = "Register `GPIO_QSPI_SD0` writer"]
pub type W = crate::W<GPIO_QSPI_SD0_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`gpio_qspi_sd0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpio_qspi_sd0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GPIO_QSPI_SD0_SPEC;
impl crate::RegisterSpec for GPIO_QSPI_SD0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio_qspi_sd0::R`](R) reader structure"]
impl crate::Readable for GPIO_QSPI_SD0_SPEC {}
#[doc = "`write(|w| ..)` method takes [`gpio_qspi_sd0::W`](W) writer structure"]
impl crate::Writable for GPIO_QSPI_SD0_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIO_QSPI_SD0 to value 0x52"]
