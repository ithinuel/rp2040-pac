#[doc = "Register `EP_ABORT_DONE` reader"]
pub type R = crate::R<EP_ABORT_DONE_SPEC>;
#[doc = "Register `EP_ABORT_DONE` writer"]
pub type W = crate::W<EP_ABORT_DONE_SPEC>;
...
impl W {
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn ep0_in(&mut self) -> EP0_IN_W<EP_ABORT_DONE_SPEC> {
        EP0_IN_W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    pub fn ep0_out(&mut self) -> EP0_OUT_W<EP_ABORT_DONE_SPEC> {
        EP0_OUT_W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    pub fn ep1_in(&mut self) -> EP1_IN_W<EP_ABORT_DONE_SPEC> {
        EP1_IN_W::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    pub fn ep1_out(&mut self) -> EP1_OUT_W<EP_ABORT_DONE_SPEC> {
        EP1_OUT_W::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    pub fn ep2_in(&mut self) -> EP2_IN_W<EP_ABORT_DONE_SPEC> {
        EP2_IN_W::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    pub fn ep2_out(&mut self) -> EP2_OUT_W<EP_ABORT_DONE_SPEC> {
        EP2_OUT_W::new(self, 5)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    pub fn ep3_in(&mut self) -> EP3_IN_W<EP_ABORT_DONE_SPEC> {
        EP3_IN_W::new(self, 6)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    pub fn ep3_out(&mut self) -> EP3_OUT_W<EP_ABORT_DONE_SPEC> {
        EP3_OUT_W::new(self, 7)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    pub fn ep4_in(&mut self) -> EP4_IN_W<EP_ABORT_DONE_SPEC> {
        EP4_IN_W::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    pub fn ep4_out(&mut self) -> EP4_OUT_W<EP_ABORT_DONE_SPEC> {
        EP4_OUT_W::new(self, 9)
    }
    #[doc = "Bit 10"]
    #[inline(always)]
    pub fn ep5_in(&mut self) -> EP5_IN_W<EP_ABORT_DONE_SPEC> {
        EP5_IN_W::new(self, 10)
    }
    #[doc = "Bit 11"]
    #[inline(always)]
    pub fn ep5_out(&mut self) -> EP5_OUT_W<EP_ABORT_DONE_SPEC> {
        EP5_OUT_W::new(self, 11)
    }
    #[doc = "Bit 12"]
    #[inline(always)]
    pub fn ep6_in(&mut self) -> EP6_IN_W<EP_ABORT_DONE_SPEC> {
        EP6_IN_W::new(self, 12)
    }
    #[doc = "Bit 13"]
    #[inline(always)]
    pub fn ep6_out(&mut self) -> EP6_OUT_W<EP_ABORT_DONE_SPEC> {
        EP6_OUT_W::new(self, 13)
    }
    #[doc = "Bit 14"]
    #[inline(always)]
    pub fn ep7_in(&mut self) -> EP7_IN_W<EP_ABORT_DONE_SPEC> {
        EP7_IN_W::new(self, 14)
    }
    #[doc = "Bit 15"]
    #[inline(always)]
    pub fn ep7_out(&mut self) -> EP7_OUT_W<EP_ABORT_DONE_SPEC> {
        EP7_OUT_W::new(self, 15)
    }
    #[doc = "Bit 16"]
    #[inline(always)]
    pub fn ep8_in(&mut self) -> EP8_IN_W<EP_ABORT_DONE_SPEC> {
        EP8_IN_W::new(self, 16)
    }
    #[doc = "Bit 17"]
    #[inline(always)]
    pub fn ep8_out(&mut self) -> EP8_OUT_W<EP_ABORT_DONE_SPEC> {
        EP8_OUT_W::new(self, 17)
    }
    #[doc = "Bit 18"]
    #[inline(always)]
    pub fn ep9_in(&mut self) -> EP9_IN_W<EP_ABORT_DONE_SPEC> {
        EP9_IN_W::new(self, 18)
    }
    #[doc = "Bit 19"]
    #[inline(always)]
    pub fn ep9_out(&mut self) -> EP9_OUT_W<EP_ABORT_DONE_SPEC> {
        EP9_OUT_W::new(self, 19)
    }
    #[doc = "Bit 20"]
    #[inline(always)]
    pub fn ep10_in(&mut self) -> EP10_IN_W<EP_ABORT_DONE_SPEC> {
        EP10_IN_W::new(self, 20)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    pub fn ep10_out(&mut self) -> EP10_OUT_W<EP_ABORT_DONE_SPEC> {
        EP10_OUT_W::new(self, 21)
    }
    #[doc = "Bit 22"]
    #[inline(always)]
    pub fn ep11_in(&mut self) -> EP11_IN_W<EP_ABORT_DONE_SPEC> {
        EP11_IN_W::new(self, 22)
    }
    #[doc = "Bit 23"]
    #[inline(always)]
    pub fn ep11_out(&mut self) -> EP11_OUT_W<EP_ABORT_DONE_SPEC> {
        EP11_OUT_W::new(self, 23)
    }
    #[doc = "Bit 24"]
    #[inline(always)]
    pub fn ep12_in(&mut self) -> EP12_IN_W<EP_ABORT_DONE_SPEC> {
        EP12_IN_W::new(self, 24)
    }
    #[doc = "Bit 25"]
    #[inline(always)]
    pub fn ep12_out(&mut self) -> EP12_OUT_W<EP_ABORT_DONE_SPEC> {
        EP12_OUT_W::new(self, 25)
    }
    #[doc = "Bit 26"]
    #[inline(always)]
    pub fn ep13_in(&mut self) -> EP13_IN_W<EP_ABORT_DONE_SPEC> {
        EP13_IN_W::new(self, 26)
    }
    #[doc = "Bit 27"]
    #[inline(always)]
    pub fn ep13_out(&mut self) -> EP13_OUT_W<EP_ABORT_DONE_SPEC> {
        EP13_OUT_W::new(self, 27)
    }
    #[doc = "Bit 28"]
    #[inline(always)]
    pub fn ep14_in(&mut self) -> EP14_IN_W<EP_ABORT_DONE_SPEC> {
        EP14_IN_W::new(self, 28)
    }
    #[doc = "Bit 29"]
    #[inline(always)]
    pub fn ep14_out(&mut self) -> EP14_OUT_W<EP_ABORT_DONE_SPEC> {
        EP14_OUT_W::new(self, 29)
    }
    #[doc = "Bit 30"]
    #[inline(always)]
    pub fn ep15_in(&mut self) -> EP15_IN_W<EP_ABORT_DONE_SPEC> {
...
You can [`read`](crate::Reg::read) this register and get [`ep_abort_done::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ep_abort_done::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct EP_ABORT_DONE_SPEC;
impl crate::RegisterSpec for EP_ABORT_DONE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ep_abort_done::R`](R) reader structure"]
...
#[doc = "`reset()` method sets EP_ABORT_DONE to value 0"]
impl crate::Resettable for EP_ABORT_DONE_SPEC {}
