...
pub type R = crate::R<CLK_ADC_CTRL_SPEC>;
#[doc = "Register `CLK_ADC_CTRL` writer"]
pub type W = crate::W<CLK_ADC_CTRL_SPEC>;
...
impl W {
    #[doc = "Bits 5:7 - Selects the auxiliary clock source, will glitch when switching"]
    #[inline(always)]
    pub fn auxsrc(&mut self) -> AUXSRC_W<CLK_ADC_CTRL_SPEC> {
        AUXSRC_W::new(self, 5)
    }
    #[doc = "Bit 10 - Asynchronously kills the clock generator"]
    #[inline(always)]
    pub fn kill(&mut self) -> KILL_W<CLK_ADC_CTRL_SPEC> {
        KILL_W::new(self, 10)
    }
    #[doc = "Bit 11 - Starts and stops the clock generator cleanly"]
    #[inline(always)]
