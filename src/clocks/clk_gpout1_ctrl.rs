#[doc = "Register `CLK_GPOUT1_CTRL` reader"]
pub type R = crate::R<CLK_GPOUT1_CTRL_SPEC>;
#[doc = "Register `CLK_GPOUT1_CTRL` writer"]
pub type W = crate::W<CLK_GPOUT1_CTRL_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CLK_GPOUT1_CTRL")
...
impl W {
    #[doc = "Bits 5:8 - Selects the auxiliary clock source, will glitch when switching"]
    #[inline(always)]
    pub fn auxsrc(&mut self) -> AUXSRC_W<CLK_GPOUT1_CTRL_SPEC> {
        AUXSRC_W::new(self, 5)
    }
    #[doc = "Bit 10 - Asynchronously kills the clock generator"]
    #[inline(always)]
    pub fn kill(&mut self) -> KILL_W<CLK_GPOUT1_CTRL_SPEC> {
        KILL_W::new(self, 10)
    }
    #[doc = "Bit 11 - Starts and stops the clock generator cleanly"]
    #[inline(always)]
    pub fn enable(&mut self) -> ENABLE_W<CLK_GPOUT1_CTRL_SPEC> {
        ENABLE_W::new(self, 11)
    }
    #[doc = "Bit 12 - Enables duty cycle correction for odd divisors"]
    #[inline(always)]
    pub fn dc50(&mut self) -> DC50_W<CLK_GPOUT1_CTRL_SPEC> {
        DC50_W::new(self, 12)
    }
    #[doc = "Bits 16:17 - This delays the enable signal by up to 3 cycles of the input clock  
 This must be set before the clock is enabled to have any effect"]
    #[inline(always)]
    pub fn phase(&mut self) -> PHASE_W<CLK_GPOUT1_CTRL_SPEC> {
        PHASE_W::new(self, 16)
    }
    #[doc = "Bit 20 - An edge on this signal shifts the phase of the output by 1 cycle of the input clock  
 This can be done at any time"]
    #[inline(always)]
    pub fn nudge(&mut self) -> NUDGE_W<CLK_GPOUT1_CTRL_SPEC> {
        NUDGE_W::new(self, 20)
    }
}
...
pub struct CLK_GPOUT1_CTRL_SPEC;
impl crate::RegisterSpec for CLK_GPOUT1_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clk_gpout1_ctrl::R`](R) reader structure"]
impl crate::Readable for CLK_GPOUT1_CTRL_SPEC {}
