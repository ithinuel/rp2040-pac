...
pub type FRAC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CLK_GPOUT3_DIV_SPEC, u8, u8, 8, O>;
...
pub type INT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CLK_GPOUT3_DIV_SPEC, u32, u32, 24, O>;
impl R {
