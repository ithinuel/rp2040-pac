...
impl W {
    #[doc = "Bits 0:7 - Fractional component of the divisor"]
    #[inline(always)]
    pub fn frac(&mut self) -> FRAC_W<CLK_SYS_DIV_SPEC> {
        FRAC_W::new(self, 0)
    }
    #[doc = "Bits 8:31 - Integer component of the divisor, 0 -> divide by 2^16"]
    #[inline(always)]
    pub fn int(&mut self) -> INT_W<CLK_SYS_DIV_SPEC> {
        INT_W::new(self, 8)
    }
}
#[doc = "Clock divisor, can be changed on-the-fly  

You can [`read`](crate::Reg::read) this register and get [`clk_sys_div::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`clk_sys_div::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
