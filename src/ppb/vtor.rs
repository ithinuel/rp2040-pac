...
#[doc = "Field `TBLOFF` reader - Bits \\[31:8\\] of the indicate the vector table offset address."]
pub type TBLOFF_R = crate::FieldReader<u32>;
#[doc = "Field `TBLOFF` writer - Bits \\[31:8\\] of the indicate the vector table offset address."]
