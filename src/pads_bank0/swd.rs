#[doc = "Register `SWD` reader"]
pub type R = crate::R<SWD_SPEC>;
#[doc = "Register `SWD` writer"]
pub type W = crate::W<SWD_SPEC>;
...
impl W {
    #[doc = "Bit 0 - Slew rate control. 1 = Fast, 0 = Slow"]
    #[inline(always)]
    pub fn slewfast(&mut self) -> SLEWFAST_W<SWD_SPEC> {
        SLEWFAST_W::new(self, 0)
    }
    #[doc = "Bit 1 - Enable schmitt trigger"]
    #[inline(always)]
    pub fn schmitt(&mut self) -> SCHMITT_W<SWD_SPEC> {
        SCHMITT_W::new(self, 1)
    }
    #[doc = "Bit 2 - Pull down enable"]
    #[inline(always)]
    pub fn pde(&mut self) -> PDE_W<SWD_SPEC> {
        PDE_W::new(self, 2)
    }
    #[doc = "Bit 3 - Pull up enable"]
    #[inline(always)]
    pub fn pue(&mut self) -> PUE_W<SWD_SPEC> {
        PUE_W::new(self, 3)
    }
    #[doc = "Bits 4:5 - Drive strength."]
    #[inline(always)]
    pub fn drive(&mut self) -> DRIVE_W<SWD_SPEC> {
        DRIVE_W::new(self, 4)
    }
    #[doc = "Bit 6 - Input enable"]
    #[inline(always)]
    pub fn ie(&mut self) -> IE_W<SWD_SPEC> {
        IE_W::new(self, 6)
    }
    #[doc = "Bit 7 - Output disable. Has priority over output enable from peripherals"]
    #[inline(always)]
    pub fn od(&mut self) -> OD_W<SWD_SPEC> {
        OD_W::new(self, 7)
    }
}
#[doc = "Pad control register  

You can [`read`](crate::Reg::read) this register and get [`swd::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`swd::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SWD_SPEC;
impl crate::RegisterSpec for SWD_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`swd::R`](R) reader structure"]
impl crate::Readable for SWD_SPEC {}
#[doc = "`write(|w| ..)` method takes [`swd::W`](W) writer structure"]
impl crate::Writable for SWD_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SWD to value 0x5a"]
impl crate::Resettable for SWD_SPEC {
