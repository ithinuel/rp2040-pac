...
pub type R = crate::R<INTERP1_ACCUM0_ADD_SPEC>;
#[doc = "Register `INTERP1_ACCUM0_ADD` writer"]
pub type W = crate::W<INTERP1_ACCUM0_ADD_SPEC>;
...
pub type INTERP1_ACCUM0_ADD_W<'a, REG> = crate::FieldWriter<'a, REG, 24, u32>;
impl R {
    #[doc = "Bits 0:23"]
    #[inline(always)]
