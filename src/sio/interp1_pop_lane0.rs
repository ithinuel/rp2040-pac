...
pub type R = crate::R<INTERP1_POP_LANE0_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`interp1_pop_lane0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
